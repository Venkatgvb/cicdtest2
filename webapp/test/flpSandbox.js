		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapbtphelloworldui1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtphelloworldui1-display": {
								"semanticObject": "sapbtphelloworldui1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.helloworldui1",
									"url": sap.ui.require.toUrl("sap/btp/helloworldui1")
								}
							}
						}
					}
